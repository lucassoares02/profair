...
class DetailsBalanceController extends ValueNotifier<StateApp> {
  ...
  final DetailsBalanceRepository _requestsStoresRepository;

  DetailsBalanceController(super.value, this._requestsStoresRepository);

  Future findRequests(int? codeProvider, int? userCode) async {
