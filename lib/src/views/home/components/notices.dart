...
//               : widget.homeController.alerts == null
//                   ? Container()
//                   : Column(
//                       children: [
...
//                                   '${widget.title}',
//                                   style:
//                                       const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: colorGreyDark),
//                                 )
//                               ],
//                             ),
//                           ),
...
//                                         left: appPadding,
//                                         right: (widget.homeController.alerts!.total - 1 == index) ? appPadding : 0),
//                                     child: Row(
//                                       children: [
//                                         Container(
//                                           width: 5,
